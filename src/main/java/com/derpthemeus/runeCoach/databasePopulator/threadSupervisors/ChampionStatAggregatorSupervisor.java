...
import com.derpthemeus.runeCoach.databasePopulator.populatorThreads.ChampionStatAggregatorThread;
...
public class ChampionStatAggregatorSupervisor extends PopulatorThreadSupervisor<ChampionStatAggregatorThread> {

	private static ChampionStatAggregatorSupervisor instance = new ChampionStatAggregatorSupervisor();

	@Override
	public Class<ChampionStatAggregatorThread> getThreadClass() {
		return ChampionStatAggregatorThread.class;
	}

	public static ChampionStatAggregatorSupervisor getInstance() {
		return instance;
	}
